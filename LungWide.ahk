...
; ---------畫垂直線----------
Gui, Add, GroupBox, w5 h640  y5 x640, 
; y-630 x+640
; ---------------Regional nodal metastasis---------------
Gui, Font, s12 bold, Arial   ; 改大改粗體
Gui, Add, Text, y15 x660, Regional nodal metastasis
Gui, Font ; 重置字體設置(不加這個 粗體改不回來)
Gui, Font, s10, Arial   ; 恢復
Gui, Add, Checkbox, vNo y35 x680, No tumor involvement of regional lymph node(s)
Gui, Add, Checkbox, vNequ y55 x680, Equivocal, location: 
Gui, Add, Checkbox, vNip y75 x700, Ipsilateral peribronchial LNs
Gui, Add, Checkbox, vNih y75 x880, Ipsilateral hilar LNS
Gui, Add, Checkbox, vNipu y75 x1015, Intrapulmonary Nodes
Gui, Add, Checkbox, vNsub y95 x700, Single ipsilateral mediastinal or subcarinal LNs ; 變內容vNsub
Gui, Add, Checkbox, vNsub1 y115 x700, Multiple ipsilateral mediastinal with/without subcarinal LNs ; 新增vNsub1
Gui, Add, Checkbox, vNch y135 x700, Contralateral hilar LNs
Gui, Add, Checkbox, vNcm y135 x853, Contrallateral mediastinal LNs 
Gui, Add, Checkbox, vNsc y135 x1050, Supraclavicular LNs
Gui, Add, Checkbox, vNis y155 x700, Ipsilateral or contralateral scalene

Gui, Add, Checkbox, vNyes y175 x680, Yes, location: 
Gui, Add, Text, y195 x700, N1:
Gui, Add, Checkbox, vNyip y195 x730, Ipsilateral peribronchial LNs
Gui, Add, Checkbox, vNyih y195 x913, Ipsilateral hilar LNS
Gui, Add, Checkbox, vNyipu y195 x1048, Intrapulmonary Nodes
Gui, Add, Text, y215 x700, N2a:
Gui, Add, Checkbox, vNysub y215 x730, Single ipsilateral mediastinal or subcarinal LNs  ; 變內容vNysub
Gui, Add, Text, y235 x700, N2b:
Gui, Add, Checkbox, vNysub1 y235 x730, Multiple ipsilateral mediastinal with/without subcarinal LNs ; 新增vNysub1
Gui, Add, Text, y255 x700, N3:
Gui, Add, Checkbox, vNych y255 x730, Contralateral hilar LNs
Gui, Add, Checkbox, vNycm y255 x883, Contrallateral mediastinal LNs 
Gui, Add, Checkbox, vNysc y255 x1080, Supraclavicular LNs
Gui, Add, Checkbox, vNyis y275 x730, Ipsilateral or contralateral scalene

; ---------------Distant Metastasis---------------
Gui, Font, s12 bold, Arial   ; 改大改粗體
Gui, Add, Text, y300 x660, Distant metastasis
Gui, Font ; 重置字體設置(不加這個 粗體改不回來)
Gui, Font, s10, Arial   ; 恢復
Gui, Add, Text, y302 x805, (in this study)
Gui, Add, Checkbox, vDM0 y320 x680, No
Gui, Add, Checkbox, vDM1 y340 x680, Yes or Equivocal: 
Gui, Font, s12 bold, Arial   ; 改大改粗體
Gui, Add, Text, y360 x680, Thoracic
Gui, Font ; 重置字體設置(不加這個 粗體改不回來)
Gui, Font, s10, Arial   ; 恢復
Gui, Add, Checkbox, vMT1 y380 x700, Yes
Gui, Add, Checkbox, vMT2 y380 x745, equivocal: Separate tumor nodule(s) in a contralateral lobe(M1a)
Gui, Add, Checkbox, vMT3 y400 x700, Yes
Gui, Add, Checkbox, vMT4 y400 x745, equivocal: Pleural or pericardial nodules or malignant pleural or pericardial effusion(M1a)

Gui, Font, s12 bold, Arial   ; 改大改粗體
Gui, Add, Text, y420 x680, Extrathoracic
Gui, Font ; 重置字體設置(不加這個 粗體改不回來)
Gui, Font, s10, Arial   ; 恢復
Gui, Add, Checkbox, vME1 y440 x700, Yes
Gui, Add, Checkbox, vME2 y440 x745, equivocal: Single lesions(M1b), Location: 
Gui, Add, Edit, vME5 y435 x1005 w140
Gui, Add, Checkbox, vME3 y470 x700, Yes
Gui, Add, Checkbox, vME4 y470 x745, equivocal: Multiple lesions(M1c), Location: 
Gui, Add, Edit, vME6 y465 x1015 w130

; ---------------Other Findings---------------
Gui, Font, s12 bold, Arial   ; 改大改粗體
Gui, Add, Text, y490 x660, Other findings
Gui, Font ; 重置字體設置(不加這個 粗體改不回來)
Gui, Font, s10, Arial   ; 恢復
Gui, Add, Edit, vOF0 y510 x660 w500

; Buttons
Gui, Font, s12 bold, Arial   ; 改大改粗體
Gui, Add, Button, Default gGenerateReport y560 x660, Generate Report
Gui, Add, Button, gExit y560 x810, Exit

; Show GUI
Gui, Show, x180 y0 w1280 h660, Lung Cancer Imaging Report Generator
return
